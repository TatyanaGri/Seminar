...
1. инициальзируем массив
2. печатаем массив
3. находим сумму отрицательных в массиве
4. находим суммму положительный в массиве
5. сумма отрицательных и положительных через один мметод
*/
